...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.xpath("//button[text()='Add to cart']"));
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//div[@class='image-container MuiBox-root css-0']"));
